      ...
      <div className="ph-screen">
        <div className="ph-board">
          ...
          <header className="ph-header">
            <button type="button" className="ph-iconbtn ph-back" aria-label="Back"><IconBack /></button>
            <span className="ph-title">{title}</span>
            <div className="ph-actions">
              <button type="button" className="ph-iconbtn" aria-label="Add"><IconPlus /></button>
              <button type="button" className="ph-iconbtn" aria-label="Menu"><IconMenu /></button>
            </div>
          </header>
          ...
          <div className="ph-body">
            <div className="ph-tabs">
              {tabs.map((t) => (
                <div key={t.label} className={`ph-tab ${t.active ? 'is-active' : ''}`}>{t.label}</div>
              ))}
            </div>
