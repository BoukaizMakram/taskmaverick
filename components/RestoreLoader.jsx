...
export default function RestoreLoader() {
  return (
    <div className="tm-loader" id="tm-boot-loader" aria-hidden="true">
      ...
      >
        <mask id="tm_m0" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="26" y="13" width="27" height="40">
        ...
        <mask id="tm_m1" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="13" y="0" width="40" height="27">
        ...
        <mask id="tm_m2" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="27" height="40">
