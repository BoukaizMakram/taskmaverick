...
// video frame. Shared by the landing reel (DesktopReel) and the industry reel
// (IndustrySlides). Clicking it plays whatever is in the enclosing
// `.video-frame-wrap` — a coded scene (which toggles play/pause on click) or a
// plain <video>.
