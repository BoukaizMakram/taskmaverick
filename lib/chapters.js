...
export const CHAPTERS = [
  {
    ...
    // in DesktopReel/MobileReel). The cover image is shown as the scene's poster
    // until the viewer hits play. Future chapters get their own coded scenes the
    // same way, reusing elements like PhoneMissions/MissionChip.
    scene: 'posted-missions',
    cover: '/Images/Automated%20Management.png',
  ...
  },
  {
    ...
    minutes: 4,
    start: 300,
    cover: '/Images/preserving%20knowledge.png',
  ...
  },
  {
    ...
    minutes: 4,
    start: 540,
    cover: '/Images/increasing%20effeciency.png',
  ...
  },
  {
    ...
    minutes: 5,
    start: 780,
    cover: '/Images/improving%20quality.png',
  ...
  },
  {
    ...
    minutes: 4,
    start: 1080,
    cover: '/Images/Automating%20Audits.png',
  ...
  },
  {
    ...
    minutes: 3,
    start: 1320,
    cover: '/Images/Requesting%20Support.png',
  ...
  },
  {
    ...
    minutes: 5,
    start: 1500,
    cover: '/Images/Live%20Monitoring.png',
  ...
  },
  {
    ...
    minutes: 4,
    start: 2160,
    cover: '/Images/Risk.png',
    heroTitle: 'HR Related Risks Are Detected Early\nTo Prevent Legal Liability',
    badges: [
      { icon: 'shield', title: 'Automated Detection', sub: 'Routine Audits Are Automatically Assigned To Detect HR Risks Before They Turn Into Legal Liability' },
      { icon: 'check', title: 'Assured Resolution', sub: 'Detected HR Issues Trigger Alert Tickets Which Require Timely Follow-Up And Resolution By Managers' },
      { icon: 'book', title: 'Detailed Records', sub: 'Records Can Be Maintained To Document All Resolutions And To Reduce Insurance Rates' },
      { icon: 'users', title: 'Reputation & Retention', sub: 'Automated Risk Detection Prevents Reputational Damage And Improves Staff Retention' },
    ],
  },
  {
    id: 10,
