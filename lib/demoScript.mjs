...
export const DEMO_SCRIPT = [
  ...
  { id: 'engagement-closed', display: 'See What’s Completed', text: null, duration: 2, feature: 'closed', chapter: 'Constant Engagement' },
  { id: 'engagement-claimed', display: 'See What’s In Progress', text: null, duration: 2, feature: 'claimed', chapter: 'Constant Engagement' },
  { id: 'engagement-open', display: 'See What’s Still Due', text: null, duration: 2, feature: 'open', chapter: 'Constant Engagement' },
  ...
  { id: 'recognition-stamped', display: 'See Who Performed Each Mission', text: null, duration: 2.4, feature: 'names', chapter: 'Recognition' },
