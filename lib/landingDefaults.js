...
import { CHAPTERS, PHILOSOPHY } from './chapters';
...
export const DEFAULT_LANDING = {
  // Home / intro reel page (before the chapters). Editable like the chapters.
  philosophy: {
    heroTitle: PHILOSOPHY.heroTitle || '',
    badges: (PHILOSOPHY.badges || []).map((b) => ({ icon: b.icon, title: b.title, sub: b.sub })),
  },
  useCases: {
    kicker: 'Use Cases By Industry',
    sub: 'Taskmaverick works across every industry. Here are just a few examples.',
